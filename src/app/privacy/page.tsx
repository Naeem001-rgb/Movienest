...
export const metadata: Metadata = {
  title: "Privacy Policy — Movie Nest",
  description: "How Movie Nest collects, uses, and protects your information.",
};
    ...
    <LegalPage title="Privacy Policy">
      ...
      <ul>
        ...
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Movie Nest.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Movie Nest, accessible from
          https://movie-nest-application.vercel.app/
        </li>
        <li>
      ...
      <p>
        ...
        information may include, but is not limited to: Usage Data.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          Cookies is to give You a more personal experience and to avoid You having to re-enter
          Your preferences every time You use the Website.
        </li>
      </ul>
      <p>
        For more information about the cookies we use and your choices regarding cookies, please
        visit our Cookies Policy or the Cookies section of this Privacy Policy.
      </p>
      ...
      <p>
        By email: <a href="mailto:support@movienest.com">support@movienest.com</a>
      </p>
    </LegalPage>
  );
}
